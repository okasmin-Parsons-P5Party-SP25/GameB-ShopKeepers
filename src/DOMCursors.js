export default class DOMCursors {
  ...
  onMouseMove(e) {
    ...
    this.#me.dom_cursors.mouse_x = e.clientX - this.#canvas.getBoundingClientRect().x;
    this.#me.dom_cursors.mouse_y = e.clientY - this.#canvas.getBoundingClientRect().y;
  }
  onMouseDown(e) {
  ...
  animate(t) {
    ...
    this.#guests.forEach((guest) => {
      ...
      const x = guest.dom_cursors.mouse_x + this.#canvas.getBoundingClientRect().x - 8;

      const y = guest.dom_cursors.mouse_y + this.#canvas.getBoundingClientRect().y - 8;
...
const colors = ["#DAD7A2", "#E5E1D5", "#FFEDAB", "#FED899", "#C6CA42", "#F1B312"];
